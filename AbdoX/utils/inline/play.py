...
def stream_markup_timer(_, chat_id, played, dur):
    ...
    buttons = [
            ...
            InlineKeyboardButton(text="ᴇ ɴ ᴅ", callback_data=f"ADMIN Stop|{chat_id}"),
            InlineKeyboardButton(text="ʀᴇsᴜᴍᴇ", callback_data=f"ADMIN Resume|{chat_id}"),
            InlineKeyboardButton(text="ᴘᴇᴜsᴇ", callback_data=f"ADMIN Pause|{chat_id}"),
         ...
         [
            InlineKeyboardButton(text="ᴛɪᴍᴏ", url=f"https://t.me/Y_a_z"),
            InlineKeyboardButton(text="ʟɪᴅᴏ", url=f"https://t.me/J0KER7x"), 
        ],
         [
            InlineKeyboardButton(text="ᴛɪᴛᴏ", url=f"https://t.me/c1_Yx"), 
        ],
        [
