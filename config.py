...
OWNER_ID = int(getenv("OWNER_ID", 5742480036))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/lotusabdo/my.git",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/X_v_C_Y")
